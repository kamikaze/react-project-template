...
export const LoginPage: React.FC = () => {
  ...
  const handleOidcLogin = useCallback(async (): Promise<void> => {
    // Log OIDC config for debugging (non-blocking)
    void logOidcConfig();
